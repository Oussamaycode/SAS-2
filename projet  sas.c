...
//On utilise type void,car l'object de ces foctions est (rechercher et afficher); on attend pas une chose specifique.
void lookfor(char T[]){
    for(int i=0;i<count;i++){
        ...
        if (strcasecmp(T,animal[i].espece)==0)
            details(i);
